...
EOT;
        ...
        DB::table('articles')->insert([
            ...
            [
                ...
                'is_published' => true,
                'likes_count' => 600,
                'created_at' => '2018/01/02 11:11:11',
                'updated_at' => '2018/01/02 11:11:11',
            ],
            [
                'id' => 3,
                'user_id' => 1,
                'title' => 'Laravelの公式ドキュメントの読み方について完全解説します!3',
                'content' => $sharedContent,
                'priority' => 'middle',
                'is_published' => true,
                'likes_count' => 160,
            ...
            [
                'id' => 4,
                'user_id' => 1,
                'title' => 'Laravelの公式ドキュメントの読み方について完全解説します!4',
                'content' => $sharedContent,
                'priority' => 'low',
                'is_published' => true,
                'likes_count' => 110,
            ...
            [
                'id' => 5,
                'user_id' => 1,
                'title' => 'Laravelの公式ドキュメントの読み方について完全解説します!5',
                'content' => $sharedContent,
                'priority' => 'low',
                'is_published' => true,
                'likes_count' => 900,
